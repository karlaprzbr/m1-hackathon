<?php
/*Ce fichier fait partie deByvexChild, byvex child theme.
...
if ( ! function_exists( 'suffice_child_enqueue_child_styles' ) ) {
	function ByvexChild_enqueue_child_styles() {
...
add_action( 'wp_enqueue_scripts', 'ByvexChild_enqueue_child_styles' );
